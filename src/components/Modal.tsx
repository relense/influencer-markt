...
const Modal = ({
  ...
  return (
    <>
      ...
      <div className="fixed top-10 z-50 w-11/12 rounded-lg bg-white sm:h-auto md:top-10 md:w-3/4 lg:w-2/4 2xl:w-6/12 3xl:w-2/4 4xl:w-4/12 5xl:w-1/4">
        <div
        ...
        <div className="z-50 flex max-h-[55vh] flex-col overflow-y-auto xxs:max-h-[60vh] xs:max-h-[65vh] xl:max-h-[75vh] 3xl:max-h-[75vh]">
          {title && (
