    ...
    <Modal onClose={params.onCloseModal} title="Value Pack Builder">
      ...
      >
        <div className="flex w-full flex-col gap-4">
          <div className="text-xl font-medium">Value Pack Title</div>
          <div className="flex w-full flex-col">
            <input
              ...
              placeholder="Provide a catchy and descriptive title for your offering"
              autoComplete="off"
            />
            {params.errors.title &&
              params.errors.title.type === "maxLength" && (
        ...
        <div className="w-full border-[1px] border-white1" />
        <div className="flex w-full flex-col gap-4">
          <div className="text-xl font-medium">Value Pack Description</div>
          <div className="flex w-full flex-col">
            <textarea
              ...
              placeholder="Tell us about the unique offering in your package"
              autoComplete="off"
            />
        ...
        <div className="w-full border-[1px] border-white1" />
        <div className="flex w-full flex-col gap-4">
          <div className="text-xl font-medium">Delivery Time</div>
          <input
        ...
        <div className="flex w-full flex-col gap-4">
          <div className="text-xl font-medium">Number of Revisions</div>
          <input
        ...
        <div className="w-full border-[1px] border-white1" />
        <div className="flex w-full flex-col gap-4">
          <div className="text-xl font-medium">Value Pack Price</div>
          <input
