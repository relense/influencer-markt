                ...
                <div className="flex flex-wrap justify-start gap-2 p-2">
                  {selectedUserSocialMedia &&
                    selectedUserSocialMedia.valuePacks.map((valuePack) => {
                      ...
                      const containerClass = `group flex w-full flex-1 lg:flex-[0_1_49%] cursor-pointer flex-col items-start gap-2 rounded-lg border p-2 text-sm font-medium hover:bg-influencer-green ${selectedContainer}`;
